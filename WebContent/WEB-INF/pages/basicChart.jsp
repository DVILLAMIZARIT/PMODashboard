...
<c:set var="folderPath" value="resources/charts/"/>
...
<c:set var="assetCSSPath" value="resources/assets/ui/css/" scope="request"/>
<c:set var="assetJSPath" value="resources/js/" scope="request"/>
<c:set var="assetImagePath" value="resources/assets/ui/images/" scope="request"/>
